...
from tools import largest_file, truncator
...
# Set device
DEVICE = torch.device("cuda")
truncator(cfg.noisy_dirs_for_train,"noisy_train")
truncator(cfg.clean_dirs_for_train,"clean_train")
truncator(cfg.noisy_dirs_for_valid,"noisy_valid")
truncator(cfg.clean_dirs_for_valid,"clean_valid")
...
pth=os.getcwd()
cl_tr=pth+"/clean_train"
ns_tr=pth+"/noisy_train"
cl_vl=pth+"/clean_valid"
ns_vl=pth+"/noisy_valid"
